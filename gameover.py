...
class GameOverView(arcade.View):
    """Écran de game over avec bouton de relance."""
    ...
    def on_show_view(self) -> None:
        ...
        self._title  = arcade.Text("GAME OVER", cx, cy + 30, arcade.color.RED, 52,
                                   font_name=ZELDA_FONT, anchor_x="center", anchor_y="center")
        self._prompt = arcade.Text("PRESS SPACE TO RESTART", cx, cy - 40, arcade.color.WHITE, 16,
